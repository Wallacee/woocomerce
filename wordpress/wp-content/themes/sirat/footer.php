        ...
        <div id="footer-2">
          	<div class="copyright container">
                ...
                <?php if( get_theme_mod( 'sirat_hide_show_scroll',true) != '') { ?>
                    ...
                    if($theme_lay == 'Left'){ ?>
                      <a href="#" class="scrollup left"><i class="<?php echo esc_html(get_theme_mod('sirat_scroll_to_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'sirat' ); ?></span></a>
                    <?php }else if($theme_lay == 'Center'){ ?>
                      <a href="#" class="scrollup center"><i class="<?php echo esc_html(get_theme_mod('sirat_scroll_to_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'sirat' ); ?></span></a>
                    <?php }else{ ?>
                      <a href="#" class="scrollup"><i class="<?php echo esc_html(get_theme_mod('sirat_scroll_to_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'sirat' ); ?></span></a>
                    <?php }?>
                <?php }?>
